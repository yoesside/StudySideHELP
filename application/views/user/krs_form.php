	...
	<div class="row">
		<div class="col">
			<div class="au-card">
				...
				<form action="<?= base_url('krs/tambah_krs_aksi') ?>" method="post">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="thn_akad_smt" class="form-control"
									value="<?= $thn_akad_smt . " - " . $semester; ?>" readonly>
							</div>
							<div class="form-group">
        ...
        ?>
							...
							<?= anchor('krs/krs_aksi', '<div class="btn btn-warning">Kembali</div>') ?>
